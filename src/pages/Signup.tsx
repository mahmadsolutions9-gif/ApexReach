    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h2 className="text-4xl font-bold tracking-tight text-slate-900 font-display">Create account</h2>
          <p className="mt-3 text-slate-500 font-medium">Start your 100% inboxing journey</p>
        </div>
        ...
        <p className="mt-10 text-center text-sm text-slate-500 font-medium">
          ...
          <Link to="/login" className="font-bold text-slate-900 hover:underline underline-offset-4">
            Sign in
          </Link>
        </p>
      </motion.div>
